  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Mohammad Tauchid</a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="barChart" style="min-height: 40px; height: 400px; max-height: 500px; max-width: 100%;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
